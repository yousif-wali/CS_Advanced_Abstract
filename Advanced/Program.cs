...
namespace Advanced
{
    ...
    public class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Total Annual Salaries (Includeing bonus): {employees.Sum(employee=>employee.Salary)}");

            Console.ReadKey();
        }

        public static void SeedData(List<IEmployee> employess)
        {
            ...
            employess.Add(teacher2);

            IEmployee headOfDepartment = EmployeeFactory.GetEmployeeInstance(EmployeeType.HeadOfDepartment, 3, "Brenda", "Mull", 50000);
            employess.Add(headOfDepartment);

            IEmployee deputyHeadMaster = EmployeeFactory.GetEmployeeInstance(EmployeeType.DeputyHeadMaster, 4, "Devlin", "Brown", 60000);
            employess.Add(deputyHeadMaster);

            IEmployee headMaster = EmployeeFactory.GetEmployeeInstance(EmployeeType.HeadMaster, 5, "Damien", "Jones", 80000);
            employess.Add(headMaster);
        }
